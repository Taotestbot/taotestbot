...
heljpMessage ="""        ✯sᴇʟғʙᴏᴛ✯͜͡ຖ ຸงເທ ົາ͜͜͜͡✯
||👉 Mention       - Mention All Member Group
||👉 Point       - Set Point Read
||👉 Read        - Reading Point
||👉 Ginfo         - Info Grup
||===== F O R   A D M I N =====||
...
#----------------- NOTIFED MEMBER OUT GROUP
        if op.type == 15:
            if op.param2 in bot1:
                return
            cl.sendText(op.param1,"ไปแล้วไม่ต้องกลับมานร้า\n(*´･ω･*)\n✯sᴇʟғʙᴏᴛ✯͜͡ຖ ຸงເທ ົາ͜͜͜͡✯")
            print "MEMBER HAS LEFT THE GROUP"
#------------------ KICK OUT FORM GROUP
        if op.type == 19:
            if op.param2 in Bots:
                return
            cl.sendText(op.param1,cl.getContact(op.param2).displayName + " โอ้โหซัดเข้าไปลูกนี้ เต็มตีนเลยครับ")
...
#----------------- NOTIFED MEMBER JOIN GROUP
        if op.type == 17:
            ...
            cl.sendText(op.param1, "มาใหม่แนะนำตัวด้วยนร้า\nยินดีต้อนรับ 😊" + cl.getContact(op.param2).displayName + " สู่กลุ่ม " + "👉" + str(ginfo.name) + "👈","เข้ามาแล้วอย่าดื้อนะ")
              ...
              if msg.from_ in admin:
                ...
                if msg.toType == 2:
                    if msg.to in wait2['readPoint']:
                        ...
                        cl.sendText(msg.to, "==============================\nActive readers:%s\n\n\n\nPassive readers:\n%s\n\n==============================\nIn the last seen point:\n[%s]\n==============================\n ✯sᴇʟғʙᴏᴛ✯͜͡ຖ ຸงເທ ົາ͜͜͜͡✯" % (wait2['readMember'][msg.to],chiya,setTime[msg.to]))
                        print "ReadPoint Set..."
                        try:
                            del wait2['readPoint'][msg.to]
                            del wait2['readMember'][msg.to]
...
#----------------------ADMIN COMMAND------------------------------#
              ...
              if msg.from_ in admin:
                ...
                cl.sendMessage(msg)
                cl.sendText(msg.to,"✯sᴇʟғʙᴏᴛ✯͜͡ຖ ຸงເທ ົາ͜͜͜͡✯")
                ...
                cl.sendText(msg.to,"✯sᴇʟғʙᴏᴛ✯͜͡ຖ ຸงເທ ົາ͜͜͜͡✯")
                cl.sendMessage(msg)
                cl.sendText(msg.to,"😸http://line.me/ti/p/~xcool.py")
